...
import { createNewRequest,createNewProperty } from "@/lib/firebase/firestore";
...
function AddnewRequest() {
  ...
  const onSubmit = async (data: {
    ...
    try {
      ...
      if (userId) await createNewProperty({ ...data, coordinates }, userId!);
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Specify property details to add
                </p>
              </div>
